...
WHERE EMP_ID != 0; -- EMP_ID 라는 INDEX를 사용한다는 의미
--> EMP_ID가 PRIMARY KEY로 정렬하는 숫자값으로 되어있기 때문에 가능

--> INDEX는 숫자로 무언가를 찾기 위한 값

--> 왜 없다고 하냐면 계정이 KH_WORKBOOK1이기 때문 --> KH_T 계정으로 변경

SELECT * FROM EMPLOYEE
WHERE EMP_ID = 200;
-- 200	선동일	621231-1985634	sun_di@or.kr	01099546325	D9	J1	S1	8000000	0.3		90/02/06		N
